...
set opt(node_size) 5                       ;# Size of nodes
set opt(target_size) [expr $opt(node_size) + 2]                     ;# Size of the target
...
set opt(hole_length) 23;                    # Length of a hole edge
