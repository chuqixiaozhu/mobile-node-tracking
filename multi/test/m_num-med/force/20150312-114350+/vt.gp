...
set ylabel "Median Effective Monitoring Ratio (%)"
set yrange [40:70]
set ytics 5
set mytics 1
set format y "%.1f"
...
plot "m_num-m-med-force_vs_vt" w lp lt 1 lw 2 pt 5 ps 2 title "Force", "m_num-m-med-direct_vs_vt" w lp lt 2 lw 2 pt 2 ps 2 title "Direct"
set output
