...
set opt(MIN_EMT) 0;           # Minimum Effective Monitoring Time of targets
...
# Calculate Minimum Effective Monitoring Time of targets
proc minimum_emt {} {
    global EMT opt
    set emt_list ""
    for {set i 0} {$i < $opt(ntarget)} {incr i} {
    ...
    set opt(MIN_EMT) [lindex $emt_list 0]
}
...
proc finish {} {
    ...
    getting_results
    #puts "minimum_effective_monitoring_time = $opt(MIN_EMT)"
