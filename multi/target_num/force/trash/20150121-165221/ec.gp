...
set output "50_target_num-multi_vs_ec.eps"
...
plot "target_num-m-force_vs_ec" u 1:($2/1000.0) w lp lt 1 lw 2 pt 5 ps 2 title "Force", "target_num-m-direct_vs_ec" u 1:($2/1000.0) w lp lt 2 lw 2 pt 2 ps 2 title "Direct"
set output
